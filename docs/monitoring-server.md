...
| `authz-service` | `authz-service:8084` | `/actuator/prometheus` | `service=authz-service` |
| `gateway-service` | `gateway-service:8080` | `/actuator/prometheus` | `service=gateway-service` |
| `editor-service` | `editor-service:8083` | `/actuator/prometheus` | `service=editor-service` |
| `redis-server` | `central-redis-exporter-dev:9121` | `/metrics` | `service=redis-server` |
